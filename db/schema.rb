...
ActiveRecord::Schema.define(version: 20140415032207) do
  ...
  add_index "carts", ["user_id"], name: "carts_user_id_fk", using: :btree
  ...
  create_table "product_items", id: false, force: true do |t|
    t.integer "product_id", null: false
    t.integer "item_id",    null: false
  end

  add_index "product_items", ["item_id"], name: "product_items_item_id_fk", using: :btree
  add_index "product_items", ["product_id"], name: "product_items_product_id_fk", using: :btree
  ...
  add_foreign_key "product_items", "products", name: "product_items_item_id_fk", column: "item_id"
